...
-- ============================================================
-- Kuis (di akhir tiap catatan & di akhir tiap kategori)
-- ============================================================
...
-- semua percobaan. Tabel dipisah per scope (bukan satu tabel dengan FK
-- nullable ganda) supaya PRIMARY KEY (user_id, note_id)/(user_id,
-- category_id) bisa jadi target ON CONFLICT langsung tanpa ambiguitas
-- index parsial.
...
-- ============================================================
-- Tanya AI (chat kontekstual di akhir catatan & akhir kategori)
-- ============================================================

-- Beda dari kuis, ini bukan konten yang dikelola admin -- murni log
-- percakapan pribadi tiap user dengan AI, jadi RLS-nya cukup "punya
-- sendiri" tanpa policy admin, dan dipisah per scope (note/kategori)
-- dengan alasan yang sama seperti note_quiz_attempts/category_quiz_attempts:
-- menghindari FK nullable ganda.
