...
// Eleventy lama ke Supabase. Jalankan setelah `supabase/schema.sql`
// dieksekusi di project Supabase kamu, dan `.env.local` sudah diisi
// (butuh SUPABASE_SECRET_KEY supaya bisa insert, karena RLS menolak
// insert dari publishable key biasa).
//
// Usage: npm run seed
